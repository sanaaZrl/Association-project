...
const menuItems = [
  ...
  { text: 'Membres', icon: <GroupIcon />, path: '/membres' },
  { text: 'Événements', icon: <EventIcon />, path: '/evenements' },
  { text: 'Paiements', icon: <PaymentIcon />, path: '/paiements' },
  { text: 'Disciplines', icon: <SportsBasketballIcon />, path: '/disciplines' },
];
